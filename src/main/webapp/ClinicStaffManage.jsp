        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="<%= request.getContextPath()%>/ClinicStaff?method=search" method="post">
                        <div class="form-group">
                            <label for="name">字段：</label>
                            <select name="key" class="form-control">
                                <option value="staffnumber">职工工号</option>
                                <option value="name">职工姓名</option>
                                <option value="username">职工用户名</option>
                        ...
                        <div class="form-group " style="margin-left: 48px">
                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#addUserModal">
										<span style="margin-right: 5px" class="" aria-hidden="true">
											<i class="fa fa-user-plus">添加职工信息</i>
											</span>
                            </button>
                        </div>
                    </form>
...
<%--                        <th>密码</th>--%>
                    ...
                    <tbody>
                    <c:forEach items="${list}" var="clinicStaff">
                        <tr>
                            <td>${clinicStaff.number}</td>
                            <td>${clinicStaff.name}</td>
                            <td>${clinicStaff.gender}</td>
                            <td>${clinicStaff.telephone}</td>
                            <td>${clinicStaff.username}</td>
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default "
                                            data-staffnumber="${clinicStaff.number}"
                                            data-name="${clinicStaff.name}"
                                            data-gender="${clinicStaff.gender}"
                                            data-telephone="${clinicStaff.telephone}"
                                            data-username="${clinicStaff.username}"
                                            data-toggle="modal"
                                    ...
                                    <button type="button" class="btn btn-danger "
                                            data-id="${clinicStaff.number}" data-toggle="modal"
                ...
                <!-- 新增职工信息 -->
                <form method="post" action="<%= request.getContextPath()%>/ClinicStaff?method=save" class="form-horizontal" style="margin-top: 0px" role="form"
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" required class="form-control" id="staffnumber"
                                                       name="staffnumber" placeholder="请输入工号">
                                            </div>
                                        </div>
                ...
                <!-- 修改职工信息 -->
                <form method="post" action="<%= request.getContextPath()%>/ClinicStaff?method=update" class="form-horizontal" style="margin-top: 0px" role="form"
                      id="form_data" style="margin: 20px;">
                                ...
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label for="user_id" class="col-sm-3 control-label">工号</label>
                                            <div class="col-sm-9">
                                                <input type="text" readonly required class="form-control" id="staffnumber"
                                                       name="staffnumber">
                                            </div>
                                        </div>
                ...
                <!-- 删除模态框示例（Modal） -->
                <form method="post" action="<%= request.getContextPath()%>/ClinicStaff?method=delete"
...
<script>
    $('#updateUserModal').on('show.bs.modal', function(event) {
        ...
        var id = button.data('staffnumber')
        ...
        modal.find('.modal-title').text('职工信息')
        modal.find('#staffnumber').val(id)
    ...
    $('#delUserModal').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('.modal-title').text('删除职工信息')
