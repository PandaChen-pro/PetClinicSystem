...
<nav class="navbar navbar-inverse" role="navigation">
    <div class="container-fluid">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a style="font-size: 26px;">爱心宠物诊所-系统管理员</a>
            </li>
        </ul>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="javascript:void(0)" class="list-group-item active" onclick="change('<%= request.getContextPath()%>/ClinicStaff?method=list',0)">
						<span class="" aria-hidden="true">
							<i class="fa fa-user-circle-o fa-fw"></i>
						</span>诊所职工管理
            </a>
            <a href="javascript:void(0)" class="list-group-item" onclick="change('<%= request.getContextPath()%>/VeterinarianManage?method=list',1)">
						<span class="" aria-hidden="true">
							<i class="fa fa-user-circle fa-fw"></i>
						</span>兽医管理
            </a>
<%--            <a href="javascript:void(0)" class="list-group-item" onclick="change('<%= request.getContextPath()%>/building?method=list',2)">--%>
<%--						<span class="" aria-hidden="true">--%>
...
<%--            </a>--%>
        ...
        <!--右边内容-->
        <iframe style="width: 81%; height: 600px; border: 0px;" src="<%= request.getContextPath()%>/ClinicStaff?method=list"></iframe>
    </div>
</div>
<%--<div class="footer">--%>
<%--    <p class="text-center">--%>
